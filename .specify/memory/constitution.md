<!--
Sync Impact Report:
- Version change: Initial -> v1.2.0
- Added Sections: Principle 4 (Zero Fake Placeholders & Explicit Secret Contracts)
- Modified Sections: Updated security invariants to forbid fake placeholders in code and workflows
- Status: ✅ Constitution ratified
-->
