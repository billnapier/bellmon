...
- [x] **Task 1: Add `LateSubmissionRecord` data model**
...
- [x] **Task 2: Implement Firestore storage & querying for late submission ledger**
...
- [x] **Task 3: Extend Canvas REST API ingestion for late submissions**
...
- [x] **Task 5: Update Speckit Status Dashboard**
