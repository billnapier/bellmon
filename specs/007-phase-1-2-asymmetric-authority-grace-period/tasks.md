...
- [ ] **Task 1: Define Enums & Input/Output Alert Models** (`src/engine/models.py`)
...
- [ ] **Task 2: Export Engine Models** (`src/engine/__init__.py`)
...
- [ ] **Task 3: Implement Weekend-Aware Elapsed Hour Calculator** (`src/engine/authority.py`)
...
- [ ] **Task 4: Implement Canvas Assignment Grace & Suppression Logic** (`src/engine/authority.py`)
...
- [ ] **Task 5: Implement PowerSchool Direct Alert Trigger Logic** (`src/engine/authority.py`)
...
- [ ] **Task 6: Create Unit Test Suite for Authority Engine** (`tests/test_authority.py`)
...
- [ ] **Task 7: Execute Pytest Suite & Code Quality Checks**
...
- [ ] **Task 8: Wire Engine into Main / Storage Integration & Update Documentation** (`src/main.py`, `specs/STATUS.md`)
